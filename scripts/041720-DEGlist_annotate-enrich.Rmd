...
head(crab_gene_go)
```
Write out the file to analyses/GO-MWU, making sure it's tab-delimited
```{r}
write.table(crab_gene_go, "../analyses/GO-MWU/2019-crab-GO-annot.tab")
```
...
```{r}
write.csv(crab_gene_log2FC, "../analyses/GO-MWU/2019-crab-GO-log2fc.csv", row.names = FALSE)
```
