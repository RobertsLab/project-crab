...
head(stress_annot)
```
Lots of missing row entries... maybe because I should instead use a newer version of the uniprot-SP-GO? Maybe I should use what I downloaded from uniprot.org?
